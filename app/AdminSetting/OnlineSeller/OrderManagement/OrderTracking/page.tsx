...
import ModifyApprovedOrderConfirmation from "./ModifyApprovedOrderConfirmation";
import ModifyPackedOrderShipped from "./ModifyPackedOrderShipped";
        ...
        <div className="rounded-3xl bg-white/70 backdrop-blur-xl p-6 shadow-[0_20px_40px_rgba(0,0,0,0.07)] transition-all">
          ...
          {activeTab === "return" && (
            <ModifyReturnOrderConfirmation
              ...
              setEmail={setEmail}
              setVaraientValue={setVaraientValue}
              setQty={setQty}
              setRate={setRate}
            />
          )}
